-- ============================================
-- DUMMY DATA FOR USOFT ACCOUNTING SYSTEM (ALTERNATIVE VERSION)
-- 10 records for each entity
-- This version uses NULL for user_type_id to avoid foreign key issues
-- ============================================
...
-- ============================================
-- 1. ACCOUNTS (10 Accounts) - Using NULL for user_type_id
-- ============================================
...
('Acc01', 'ABC Suppliers', 'اے بی سی سپلائرز', 'supplier', NULL, 'Ahmed Khan', '021-1234567', '0300-1234567', 'abc@suppliers.com', 'Shop 5, Main Market', 'Karachi', 50000.00, 'credit', 'active'),
('Acc02', 'Hassan Store', 'حسن اسٹور', 'both', NULL, 'Hassan Ali', '021-2345678', '0301-2345678', 'hassan@store.com', 'Plot 10, Commercial Area', 'Lahore', 75000.00, 'debit', 'active'),
('Acc03', 'Multi Trade', 'ملٹی ٹریڈ', 'both', NULL, 'Usman Malik', '021-3456789', '0302-3456789', 'multitrade@email.com', 'Street 20, Business Hub', 'Islamabad', 100000.00, 'credit', 'active'),
('Acc04', 'Global Imports', 'گلوبل امپورٹس', 'supplier', NULL, 'Zain Abbas', '021-4567890', '0303-4567890', 'global@imports.com', 'Warehouse 15, Industrial Zone', 'Karachi', 25000.00, 'credit', 'active'),
('Acc05', 'City Traders', 'سٹی ٹریڈرز', 'customer', NULL, 'Bilal Ahmed', '021-5678901', '0304-5678901', 'city@traders.com', 'Shop 25, City Center', 'Lahore', 30000.00, 'debit', 'active'),
('Acc06', 'Prime Wholesale', 'پرائم ہول سیل', 'supplier', NULL, 'Faisal Khan', '021-6789012', '0305-6789012', 'prime@wholesale.com', 'Building 30, Wholesale Market', 'Karachi', 60000.00, 'credit', 'active'),
('Acc07', 'Best Deal Store', 'بسٹ ڈیل اسٹور', 'customer', NULL, 'Kamran Ali', '021-7890123', '0306-7890123', 'bestdeal@store.com', 'Shop 40, Main Bazaar', 'Rawalpindi', 15000.00, 'debit', 'active'),
('Acc08', 'Super Mart', 'سپر مارٹ', 'both', NULL, 'Tariq Hussain', '021-8901234', '0307-8901234', 'super@mart.com', 'Mall Floor 2, Shopping Center', 'Lahore', 80000.00, 'credit', 'active'),
('Acc09', 'Elite Distributors', 'ایلائٹ ڈسٹری بیوٹرز', 'supplier', NULL, 'Sajid Mehmood', '021-9012345', '0308-9012345', 'elite@dist.com', 'Office 50, Trade Center', 'Karachi', 45000.00, 'credit', 'active'),
('Acc10', 'Quick Sales', 'کوئک سیلز', 'customer', NULL, 'Nadeem Sheikh', '021-0123456', '0309-0123456', 'quick@sales.com', 'Shop 60, Market Street', 'Faisalabad', 20000.00, 'debit', 'active');
...
-- SUMMARY
-- ============================================
-- Accounts: 10 records (Acc01 - Acc10) - user_type_id set to NULL
