...
$translations = [
    'ur' => [
        ...
        'total_sold' => 'کل فروخت',
        'opening_debit_balance' => 'افتتاحی بنام بیلنس',
        ...
        'all_bills_type' => 'سب',
        'purchase_bills_type' => 'خرید',
        'sale_bills_type' => 'فروخت',
        'receipt' => 'وصولی',
        'payment' => 'ادائیگی',
        'total_assets' => 'کل جائیداد',
        'total_liabilities' => 'کل ذمہ داریاں',
        'opening_credit_balance' => 'افتتاحی جمع بیلنس',
    ...
    'en' => [
        ...
        'total_items_low_stock' => 'items have low stock',
        'total_items_out_stock' => 'items are out of stock',
