...
$translations = [
    'ur' => [
        ...
        'please_select_account_for_report' => 'براہ کرم اکاؤنٹ منتخب کریں',
        'no_movements_period' => 'اس مدت میں کوئی حرکت نہیں ملی',
        'please_select_item' => 'براہ کرم جنس منتخب کریں',
        'item_name_label' => 'جنس',
        'stock_label' => 'سٹاک',
        'low_stock_status' => 'کم سٹاک',
        'normal_status' => 'عام',
        'out_of_stock_status' => 'ختم',
        'difference' => 'فرق',
        'all_stock_ok' => 'تمام جنس کا سٹاک مناسب ہے',
        'total_items_low_stock' => 'کل جنس کم سٹاک میں ہیں',
        'total_items_out_stock' => 'کل جنس ختم سٹاک میں ہیں',
        'low_stock_check' => 'کم سٹاک',
        ...
        'stock_only_transactions' => 'سٹاک صرف خرید/فروخت کے ذریعے تبدیل ہو سکتا ہے',
        ...
        'new_sale' => 'نیا سیل شامل کریں',
        'new_item' => 'نیا ائٹم بنائیں',
        'all_purchases_list' => 'تمام مال آمد لسٹ',
        'all_sales_list' => 'تمام سیل لسٹ',
        'all_transactions_list' => 'تمام لین دین لسٹ',
        'all_items_list' => 'تمام جنس لسٹ',
        'add_user_type_title' => 'یوزر ٹائپ شامل کریں',
        'new_user_type' => 'نیا یوزر ٹائپ',
        'all_user_types' => 'تمام یوزر ٹائپس',
        ...
        'current_stock_label' => 'موجودہ سٹاک',
    ],
    'en' => [
        'app_name' => 'Yusuf & Co',
        'app_name_en' => 'Yusuf & Co',
