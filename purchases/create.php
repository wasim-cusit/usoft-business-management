                ...
                <form method="POST" action="" id="purchaseForm">
                    ...
                    <div class="card mb-4">
                        <div class="card-header bg-light">
                            <h6 class="mb-0"><?php echo t('item_info'); ?></h6>
                        </div>
                        <div class="card-body">
                            ...
                            <button type="button" class="btn btn-success btn-sm" id="addRow">
                                <i class="fas fa-plus"></i> <?php echo t('add_new'); ?> <?php echo t('items'); ?>
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="mt-4">
                        ...
                        <a href="<?php echo BASE_URL; ?>purchases/list.php" class="btn btn-secondary btn-lg">
                            <i class="fas fa-list"></i> <?php echo t('view'); ?> <?php echo t('all_purchases'); ?>
                        </a>
                    </div>
                </form>
            </div>
