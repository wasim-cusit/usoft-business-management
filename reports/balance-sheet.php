...
<div class="page-header">
    <div class="d-flex justify-content-between align-items-center flex-wrap">
        <h1><i class="fas fa-file-alt"></i> بیلنس شیٹ</h1>
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">بیلنس شیٹ - <?php echo formatDate($asOnDate); ?></h5>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        <h5 class="text-primary">جائیداد (Assets)</h5>
                        <table class="table table-bordered">
                            <tr>
                                <td><strong>افتتاحی ڈیبٹ بیلنس</strong></td>
                                <td class="text-end"><?php echo formatCurrency($opening['opening_debit']); ?></td>
                            </tr>
                            <tr>
                                <td><strong>خرید کا بیلنس</strong></td>
                                <td class="text-end"><?php echo formatCurrency($purchaseBalance); ?></td>
                            </tr>
                            <tr>
                                <td><strong>کیش بنام</strong></td>
                                <td class="text-end"><?php echo formatCurrency($trans['total_debit']); ?></td>
                            </tr>
                            <tr class="bg-light">
                                <td><strong>کل جائیداد</strong></td>
                    ...
                    <div class="col-md-12">
                        <table class="table table-bordered">
                            <tr class="bg-info text-white">
                                <td><strong>خالص مالیت (Net Worth)</strong></td>
